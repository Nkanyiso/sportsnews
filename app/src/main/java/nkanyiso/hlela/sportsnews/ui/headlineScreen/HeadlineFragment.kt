...
class HeadlineFragment : androidx.fragment.app.Fragment(),HeadlineAdapter.ItemClick {
    override fun setClick(headlineEntity: HeadlineEntity) {
        view?.let {
            var articleUrl=headlineEntity.SiteName+"/"+headlineEntity.UrlName+"/news/"+headlineEntity.UrlFriendlyDate+"/"+headlineEntity.UrlFriendlyHeadline+"?format=json"
  ...
  //  lateinit var view :View;
    override fun onCreateView(
     ...
     // this.activity?.actionBar?.title = getString(R.string.lbl_news)
